...
const CartSection = () => {
  const {cartFood,subTotal,storeOrder}= useContext(CartContext);
...
<div className=" order-2 order-lg-1 m-auto m-lg-0">
    ...
    <div className='cart-box w-100 order-1 order-lg-2'>
      ...
      {cartFood.length ===0 ? <NoItem/> : <div className="row overflow-auto" style={{height : "80vh"}}>
        ...
        <div className="cart-total col-12 col-md-5">
          <div className="cart-total-box p-3 bg-primary-subtle ">
            ...
            <button onClick={()=> storeOrder()} className="checkOut-btn w-75 ">Checkout</button>
          </div>
